(function (ng) {
    ...
    var module = ng.module('services.notifications', []);
    module.factory('notifications', ['$rootScope', function ($rootScope) {
        ...
        var addNotification = function (notificationsArray, notificationObj) {
            if (!ng.isObject(notificationObj)) {
        ...
        $rootScope.$on('$routeChangeSuccess', function () {
            ...
            notifications.ROUTE_CURRENT = ng.copy(notifications.ROUTE_NEXT);
        ...
        notificationsService.remove = function (notification) {
            ng.forEach(notifications, function (notificationsByType) {
